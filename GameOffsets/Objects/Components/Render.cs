namespace GameOffsets.Objects.Components
{
    ...
    public struct RenderOffsets
    {
        ...
        [FieldOffset(0xB0)] public StdTuple3D<float> CurrentWorldPosition;
        ...
        [FieldOffset(0xBC)] public StdTuple3D<float> CharactorModelBounds;
        ...
        [FieldOffset(0x114)] public float TerrainHeight;
    }
}
